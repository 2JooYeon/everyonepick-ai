...
def swap_face(user_face_embedding, source_img, target_img, target_faces):
    ...
    source_face = find_user_face(source_img_rotated, user_face_embedding)
    ...
    source_face_mask[t_start_y:t_end_y + 1, t_start_x:t_end_x + 1] = source_face_image[
                                                                     s_start_y:s_end_y + 1,
                                                                     s_start_x:s_end_x + 1]
    ...
    source_seg_mask[t_start_y:t_end_y + 1, t_start_x:t_end_x + 1] = source_seg_label[
                                                                    s_start_y:s_end_y + 1,
                                                                    s_start_x:s_end_x + 1]
